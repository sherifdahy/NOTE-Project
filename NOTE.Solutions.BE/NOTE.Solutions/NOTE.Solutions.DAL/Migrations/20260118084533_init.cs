    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCompanies", x => new { x.ApplicationUserId, x.CompanyId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserContexts", x => new { x.ContextId, x.ApplicationUserId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserContexts_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUserContexts_Contexts_ContextId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, false, "SystemAdmin" });
            ...
            migrationBuilder.InsertData(
                table: "ApplicationUserContexts",
                columns: new[] { "ApplicationUserId", "ContextId" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserContexts_ApplicationUserId",
                table: "ApplicationUserContexts",
