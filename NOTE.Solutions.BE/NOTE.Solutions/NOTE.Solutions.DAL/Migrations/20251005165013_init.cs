    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActiveCodesId = table.Column<int>(type: "int", nullable: false),
                    CompaniesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveCodeCompany", x => new { x.ActiveCodesId, x.CompaniesId });
                    table.ForeignKey(
                        name: "FK_ActiveCodeCompany_ActiveCodes_ActiveCodesId",
                        column: x => x.ActiveCodesId,
                        principalTable: "ActiveCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActiveCodeCompany_Companies_CompaniesId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, null, null, "A999212D-E3FE-410C-BEA5-888AD868482C", "admin@note-solutions.com", true, "", false, null, "", "ADMIN@NOTE-SOLUTIONS.COM", "ADMIN@NOTE-SOLUTIONS.COM", "AQAAAAIAAYagAAAAEEtQIZAVuzZF1s31w4gCGq61d/mwk26VtX5vmQwcH7zEy2wzutlkJkeEbxkwuGqPVg==", null, false, "3F52186E-A158-4F4A-8822-ABEE912135EB", false, "admin@note-solutions.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "permissions", "permissions:read", 1 },
                    { 3, "permissions", "roles:read", 1 },
                    { 4, "permissions", "roles:create", 1 },
                    { 5, "permissions", "roles:update", 1 },
                    { 6, "permissions", "roles:toggleStatus", 1 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActiveCodeCompany_CompaniesId",
