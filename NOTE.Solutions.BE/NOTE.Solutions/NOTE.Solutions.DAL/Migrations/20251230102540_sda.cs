    ...
    public partial class sda : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationDashboard", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationRoleDashboards",
                columns: table => new
                {
                    ApplicationRoleId = table.Column<int>(type: "int", nullable: false),
                    ApplicationDashboardId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationRoleDashboards", x => new { x.ApplicationDashboardId, x.ApplicationRoleId });
                    table.ForeignKey(
                        name: "FK_ApplicationRoleDashboards_ApplicationDashboard_ApplicationDashboardId",
                        column: x => x.ApplicationDashboardId,
                        principalTable: "ApplicationDashboard",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationRoleDashboards_AspNetRoles_ApplicationRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPermissionOverride", x => new { x.ApplicationUserId, x.RoleClaimId });
                    table.ForeignKey(
                        name: "FK_UserPermissionOverride_AspNetRoleClaims_RoleClaimId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyManager", x => new { x.CompaniesId, x.ManagersId });
                    table.ForeignKey(
                        name: "FK_CompanyManager_Companies_CompaniesId",
                        column: x => x.CompaniesId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyManager_Managers_ManagersId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "727F7C04-0A04-4012-9AA0-5BDF83C53788", false, false, "SystemAdmin", "SYSTEMADMIN" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "A999212D-E3FE-410C-BEA5-888AD868482C", "admin@note-solutions.com", true, "", false, false, false, null, "", "ADMIN@NOTE-SOLUTIONS.COM", "ADMIN@NOTE-SOLUTIONS.COM", "AQAAAAIAAYagAAAAEF+Pt4tc0R+fWhwPlI8gsMtFvQbZWpTQ+8LAIul+So3DIpYKvIvI1hxS7zfCOSSQIA==", null, false, "3F52186E-A158-4F4A-8822-ABEE912135EB", false, "admin@note-solutions.com" });
            ...
            migrationBuilder.InsertData(
                table: "ApplicationRoleDashboards",
                columns: new[] { "ApplicationDashboardId", "ApplicationRoleId" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoleDashboards_ApplicationRoleId",
                table: "ApplicationRoleDashboards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyManager_ManagersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissionOverride_RoleClaimId_ApplicationUserId",
                table: "UserPermissionOverride",
                columns: new[] { "RoleClaimId", "ApplicationUserId" },
                unique: true);
        }
