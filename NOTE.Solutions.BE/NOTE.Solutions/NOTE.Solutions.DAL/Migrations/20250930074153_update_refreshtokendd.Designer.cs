...
namespace NOTE.Solutions.DAL.Migrations
{
    ...
    [Migration("20250930074153_update_refreshtokendd")]
    partial class update_refreshtokendd
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("NOTE.Solutions.Entities.Entities.Identity.RefreshToken", "RefreshTokens", b1 =>
                        {
                            ...
                            b1.Property<int>("ApplicationUserId1")
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("ApplicationUserId1");
                            ...
                            b1.HasOne("NOTE.Solutions.Entities.Entities.Identity.ApplicationUser", "ApplicationUser")
                                .WithMany()
