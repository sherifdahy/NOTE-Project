...
public static class Permissions
{
    ...
    #region POS Permissions
    public const string GetPointOfSales = "pointOfSales:read";
    public const string CreatePointOfSales = "pointOfSales:create";
    public const string UpdatePointOfSales = "pointOfSales:update";
    public const string ToggleStatusPointOfSales = "pointOfSales:toggleStatus";
    #endregion
